...
//all translation happens live. We check each user's keystrokes
...
function pickLanguage(array){
    ...
    if(document.getElementById('french').selected==True){
    Translator.translateToFrench(array);
	}
	else if(document.getElementById('spanish').selected==True{
	Translator.translateToSpanish(array); 
	}
	else (document.getElementById('german').selected==True{
